...
class ImageEnhancementVisualizer:
    ...
    def display_single_image_on_axes(self, matplotlib_axes, image_array, image_title):
    ...
    def display_histogram_on_axes(self, matplotlib_axes, image_array, histogram_title, bar_color):
    ...
    def display_single_image_with_histogram_analysis(self, image_array, image_title, figure_save_path=None, display_plot_immediately=True):
        ...
        self.display_single_image_on_axes(image_axes, image_array, 'Image')
        self.display_histogram_on_axes(histogram_axes, image_array, 'Histogram', 'blue')
        plt.tight_layout()
        if figure_save_path:
            plt.savefig(figure_save_path, dpi=self.image_resolution_dpi, bbox_inches='tight')
            logger.info(f"Figure saved to {figure_save_path}")
